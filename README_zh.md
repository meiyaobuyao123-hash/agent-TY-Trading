...
[架构蓝图](docs/world-model-blueprint-zh.md) | [插件架构](docs/open-architecture.md) | [免费数据源](docs/free-data-sources-research-zh.md) | [贡献指南](CONTRIBUTING_zh.md) | [English](README.md)
...
```
┌─────────────────────────────────────────────────────────┐
│  第四层: 自我进化器 (Self-Evolver)                         │
│  策略基因组 · 自然选择 · 元认知                             │
│  校准跟踪 · 适应度评估                                     │
├─────────────────────────────────────────────────────────┤
│  第三层: 认知偏差猎手 (Cognitive Bias Hunter)               │
│  羊群效应检测 · 锚定偏差 · 近因偏差                         │
│  过度自信 · 理性价格偏离分析                                │
├─────────────────────────────────────────────────────────┤
│  第二层: 因果推理引擎 (Causal Reasoning Engine)             │
│  因果 DAG · 贝叶斯更新 · 博弈论建模                        │
│  市场机制检测 · 反身性分析                                  │
├─────────────────────────────────────────────────────────┤
│  第一层: 世界感知器 (World Perceiver)                      │
│  链上数据 · 订单流 · 社交情绪                               │
│  经济指标 · 新闻 · 预测市场                                 │
└─────────────────────────────────────────────────────────┘
```
...
| 层级 | 目的 | 关键技术 |
|---|---|---|
| **世界感知器** | 从所有市场采集并标准化数据 | DeFiLlama, Binance WS, FRED, AKShare, Polymarket, Dune |
| **因果推理引擎** | 维护因果理解并生成假设 | 贝叶斯网络、因果 DAG、概率编程 |
| **认知偏差猎手** | 检测市场定价中的认知偏差 | 偏差检测器、理性价格模型、偏离分析 |
| **自我进化器** | 演化策略并持续自我改进 | 遗传算法、元认知、校准跟踪 |
...
- Python 3.11+（核心引擎）
- Node.js 20+（可选，用于 TypeScript 插件）
- Git
...
| [开放插件架构](docs/open-architecture.md) | 插件系统设计（Python + TypeScript） |
