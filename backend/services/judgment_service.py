...
async def _fetch_crypto_mcap_rankings() -> dict[str, dict]:
    ...
    coingecko_id_map = {
        ...
        "memecoin-2": "MEME-USD",
        # R21 DeFi/L2
        "pendle": "PENDLE-USD", "ethena": "ENA-USD",
...
DATA_SOURCE_MAP = {
    ...
    "jp-equities": "yfinance-global",
    "eu-equities": "yfinance-global",
...
_MARKET_TYPE_ENUM = {
    ...
    "jp-equities": MarketType.JP_EQUITIES,
    "eu-equities": MarketType.EU_EQUITIES,
