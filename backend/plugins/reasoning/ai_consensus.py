...
MARKET_TYPE_CONTEXT = {
    "crypto": (
        ...
        "请遵循以下规则:\n"
        "1. 如果24h涨跌幅在-2%到+2%之间，且没有极端技术指标(RSI<20或>80)，默认预测flat\n"
        "2. 只有当24h涨跌幅>3%或RSI处于极端水平时，才考虑预测up/down\n"
        "3. flat_probability在大多数情况下应该>=0.40\n"
        "4. 不要因为近期微跌(-1%到0%)就预测下跌，这在4h窗口内属于正常噪声\n"
        "5. 均值回归: 如果已经跌了>3%，反弹概率反而高于继续下跌\n"
    ),
    "us-equities": (
